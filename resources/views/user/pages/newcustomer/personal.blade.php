                            ...
                            <div id="form-step-0" class="tab-pane px-0" role="tabpanel" aria-labelledby="form-step-0"
                                ...
                                <div class="container row">
                                    <div class="col-0 col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="gender_personal" class="form-label">
                                                Jenis Kelamin
                                            ...
                                            @endphp
                                            <select class="form-select" name="gender_personal" id="gender_personal">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-6">
                                                <label for="custPOBPersonal" class="form-label">
                                                    Tempat Lahir
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" class="form-control" id="custPOBPersonal"
                                                    name="custPOBPersonal" placeholder="Masukkan Tempat Lahir Anda..."
                                                    value="{{ old('custPOBPersonal') }}">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="custDOBPersonal" class="form-label">
                                                    Tanggal Lahir
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <input type="date" class="form-control" id="custDOBPersonal"
                                                    name="custDOBPersonal" placeholder="Masukkan Tanggal Lahir Anda..."
                                                    value="{{ old('custDOBPersonal') }}">
                                            </div>
                                        </div>
                                        <div class="mb-3">
